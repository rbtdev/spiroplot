...
var Spirograph = {
	...
	initializeSpiro: function () {
		...
		armSpecs[0] = {
			length: this.arm1Length,
			speed: 1,
			startAngle: this.arm1StartAngle
		};
		armSpecs[1] = {
			length: this.arm2Length,
			speed: this.arm2Speed,
			startAngle: this.arm2StartAngle
		};
		armSpecs[2] = {
			length: this.arm3Length,
			speed: this.arm3Speed,
			startAngle: this.arm3StartAngle
		};
